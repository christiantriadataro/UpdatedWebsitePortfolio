      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="py-16 max-sm:px-16 lg:px-16 gap-y-16 gap-x-5 flex flex-col md:overflow-y-auto">
          <div className="text-secondary-blue text-sm">
            Hi @everyone! 👋 My name is Christian Dataro and I'm Full-Stack
            developer. Some years ago I decided to refuse Hogwarts Acceptance
            Letter to learn another type of magic. I'm currently searching for a
            Full-stack Developer. The most of my software is built with TailWind
            and React TypeScript. I also have worked with Machine Learning using
            Python Libraries and Frameworks such as Django, Django Rest
            Framework, FastAPI, Keras,TenserFlow, Seaborn, Numpy, and others.
          </div>
          <SectionExperience />
          <SectionEducation />
          <SectionMoocs />
...
const EXPERIENCE_TABS = [
  {
    ...
    description: [
      ...
      "Used Technologies: Figma, Tailwind, React, TanStack Router, TypeScript, Axios, Postman, ShadCN, TanStack Query",
      "Backend Technologies: Java Spring Boot, Spring Boot API Fox (Open API), .NET, .NET API Fox (Open API)",
    ],
  },
  {
    ...
    description: [
      ...
      "Converted web design components into reusable React components, maintaining code quality and scalability.",
      "Collaborating with backend developers to integrate frontend components with backend APIs.",
      "Used Technologies: Figma, Tailwind, React, TypeScript, Axios, SignalR, Redux, Postman, BrowserStack, Sentry, NextJS",
      "Backend Technologies:  .NET, SignalR,  .NET Swagger (Open API)",
    ],
  },
  {
    image: "/assets/image/omdena.jpg",
    position: "Lead Full Stack/ML Engineer",
    place: "Omdena",
    ...
    description: [
      ...
      "Used Technologies: Figma, Tailwind, React, TypeScript, Axios, Django, FastAPI, Redux, Postman, BrowserStack, Sentry",
  ...
  },
  {
    ...
    description: [
      ...
      "Used Technologies: Figma, Tailwind, React, TypeScript, Axios, Python, Redux, Postman ",
    ],
  },
  {
