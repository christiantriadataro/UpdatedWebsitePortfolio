...
const EducationSnippet = () => {
    return (
        <div className="lg:w-full h-fit lg:h-full">
            <div
                className="lg:w-[173px] h-[34px] border-x border-[#1E2D3D] flex flex-row pl-4 justify-between pr-2 items-center">
                <div className="text-[12px] text-[#607B96]">Education.jsx</div>
                <CloseIcon/>
            </div>
            <div className="lg:h-[452px] w-full border-t border-l border-[#1E2D3D] flex flex-row">
