import Bolt from "./SnakeGame/Bolt.jsx";
import UpArrow from "./SnakeGame/UpArrow.jsx";
import LeftArrow from "./SnakeGame/LeftArrow.jsx";
import DownArrow from "./SnakeGame/DownArrow.jsx";
import RightArrow from "./SnakeGame/RightArrow.jsx";
import SnakesFood from "./SnakeGame/SnakesFood.jsx";

const SnakeGame = ({children}) => {
    return (
        <div className="hidden w-[361px] h-[363px] rounded-lg
        ...
        shadow-[inset_0_2px_0_rgba(255,255,255,0.3)]">
            ...
            <div className="h-full flex flex-row justify-center items-center gap-[18px]">
                <div className="bg-[#011627]/[.84] w-[168px] h-[310px] rounded-lg shadow-[inset_1px_5px_11px_rgba(2,18,27,0.71)]">
                    <div className="h-full w-full">
                        <SnakesFood className="mt-[35px] ml-[50px] animate-pulse" />
                    </div>
                    <div className="absolute left-[19%] bottom-[18%]">
                        <button className="bg-[#FEA55F] rounded-lg text-[10px] w-[78px] h-[29px] border-2 border-gray-900 text-black">start-game</button>
                    </div>
                </div>
                <div className="flex flex-col justify-between items-center h-full">
                    ...
                    <div className="flex justify-end">
                        <button className="border border-[#E5E9F0] w-[79px] h-[29px] rounded-lg text-[10px] text-[#E5E9F0]">skip
                        </button>
                    </div>
                </div>
            </div>
